/*
* Note of Alessandro Manzi
* This is the original code from Kinova migrated from electric to fuerte
* I followed this link for migration: http://ros.org/wiki/geometry/bullet_migration
*/
...
#include <tf/LinearMath/Matrix3x3.h> // ALE fuerte compatibility
#include <tf/LinearMath/Vector3.h> // ALE fuerte compatibility
#include <tf/LinearMath/Quaternion.h> // ALE fuerte compatibility
