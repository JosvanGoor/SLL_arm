...
void depthCallback(const sensor_msgs::PointCloud2ConstPtr& cloudMsg)
{
    ...
    passthrough_filter.setFilterLimits(0.3, 5);     // Remove everything with a height < 0.3 m
...
int main(int argc, char** argv) 
{
	...
	ros::Subscriber depth_sub = n.subscribe<sensor_msgs::PointCloud2>("voxel_grid/output", 1, depthCallback);
