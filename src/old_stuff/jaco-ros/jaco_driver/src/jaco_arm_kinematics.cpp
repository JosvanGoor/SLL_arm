...
JacoKinematics::JacoKinematics(const ros::NodeHandle &node_handle)
{
    ...
    node_handle.param<double>("j2_to_j3", j2_to_j3_, 0.2900);
    node_handle.param<double>("j3_offset", j3_offset_, -0.0070);
    node_handle.param<double>("j3_to_j4", j3_to_j4_, 0.1233);
    node_handle.param<double>("j4_to_j5", j4_to_j5_, 0.0741);
    node_handle.param<double>("j5_to_j6", j5_to_j6_, 0.0741);
    node_handle.param<double>("j6_to_end", j6_to_end_, 0.1600);
...
void JacoKinematics::updateForward(float q1, float q2, float q3, float q4, float q5, float q6)
{
    ...
    *******               *******/
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    ...
                                                    concatTfName(tf_prefix_, "mico_base_link")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_base_link"),
                                                    concatTfName(tf_prefix_, "mico_api_origin")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_base_link"),
                                                    concatTfName(tf_prefix_, "mico_shoulder_link")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_shoulder_link"),
                                                    concatTfName(tf_prefix_, "mico_upper_arm_link")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_upper_arm_link"),
                                                    concatTfName(tf_prefix_, "mico_lower_arm_link")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_lower_arm_link"),
                                                    concatTfName(tf_prefix_, "mico_elbow_pitch_joint_offset")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_elbow_pitch_joint_offset"),
                                                    concatTfName(tf_prefix_, "mico_lower_arm_roll_link")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_lower_arm_roll_link"),
                                                    concatTfName(tf_prefix_, "mico_wrist_link")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_wrist_link"),
                                                    concatTfName(tf_prefix_, "mico_hand_link")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_hand_link"),
                                                    concatTfName(tf_prefix_, "mico_finger_1_link")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_hand_link"),
                                                    concatTfName(tf_prefix_, "mico_finger_2_link")));
    ...
    broadcaster_.sendTransform(tf::StampedTransform(transform, ros::Time::now(),
                                                    concatTfName(tf_prefix_, "mico_hand_link"),
                                                    concatTfName(tf_prefix_, "mico_finger_3_link")));
}
