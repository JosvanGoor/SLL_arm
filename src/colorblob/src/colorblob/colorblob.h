...
class Colorblob
{
  ...
  ros::Publisher d_bbox_pub;
	...
	void writeToMemory(std::vector<cv::Rect>& obs, std::string name, colorblob::BboxArray& message);
	void findBlobs(color_object& object, colorblob::BboxArray& message);
