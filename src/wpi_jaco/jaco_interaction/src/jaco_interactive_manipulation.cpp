...
JacoInteractiveManipulation::JacoInteractiveManipulation() :
    acGripper("mico_arm/manipulation/gripper", true), acLift("mico_arm/manipulation/lift", true), acHome(
        "mico_arm/home_arm", true)
{
  loadParameters(n);
  ...
  //messages
  cartesianCmd = n.advertise<wpi_jaco_msgs::CartesianCommand>("mico_arm/cartesian_cmd", 1);
  jointStateSubscriber = n.subscribe("mico_arm/joint_states", 1, &JacoInteractiveManipulation::updateJoints, this);

  //services
  eraseTrajectoriesClient = n.serviceClient<std_srvs::Empty>("mico_arm/erase_trajectories");
  jacoFkClient = n.serviceClient<wpi_jaco_msgs::JacoFK>("mico_arm/kinematics/fk");
...
void JacoInteractiveManipulation::makeHandMarker()
{
  ...
  if (arm_name_ == "jaco2")
    ...
    iMarker.header.frame_id = "mico_link_base";
...
{
  n.param("wpi_jaco/arm_name",                arm_name_,              std::string("mico"));
