  ...
  : arm_initialized (false)
{
  ...
  if (kinova_gripper_)
  {
    gripper_server_                 = new GripperServer( nh, topic_prefix_ + "_hand/fingers_controller/gripper", boost::bind(&JacoArmTrajectoryController::execute_gripper, this, _1), false);
    gripper_server_radian_          = new GripperServer( nh, topic_prefix_ + "_hand/fingers_controller_radian/gripper", boost::bind(&JacoArmTrajectoryController::execute_gripper_radian, this, _1), false);

    gripper_client_                 = new GripperClient( topic_prefix_ + "_hand/fingers_controller/gripper");
  }
